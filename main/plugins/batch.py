...
@Drone.on(events.NewMessage(incoming=True, from_users=745084259, pattern='/cancel'))
...
@Drone.on(events.NewMessage(incoming=True, from_users=745084259, pattern='/batch'))
